...
/* 变量定义区 */
//设定传感器信息上报的缓存
uint8_t SENSOR_DATA_BYTE[248] ={FRAME_HEADER_BYTE_1,FRAME_HEADER_BYTE_2,FRAME_HEADER_BYTE_3,FRAME_HEADER_BYTE_4,FRAME_HEADER_BYTE_5,//帧头（5 个字节）
														0x35, //数据区长度（1 个字节）
														0x01, //类型为数据（1 个字节）
														0x01, //为传感器数据（1 个字节）
														0x10, //传感器数据长度（1 个字节）
